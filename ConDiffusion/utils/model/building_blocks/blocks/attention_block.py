...
from typing import Literal, Sequence, Any, Callable, Union, Optional

from utils.model.building_blocks.model_utils import default_init, reshape_jax_torch
from utils.model.building_blocks.layers.residual import CombineResidualWithSkip
from utils.model.building_blocks.layers.multihead_attention import (
    MultiHeadDotProductAttention,
)
from utils.model.building_blocks.layers.axial_attention import (
...
class AxialSelfAttentionBlock(nn.Module):
    ...
    def __init__(
        ...
        attention_axes: Union[int, Sequence[int]] = -2,
        add_position_embedding: Union[bool, Sequence[bool]] = True,
        num_heads: Union[int, Sequence[int]] = 1,
        normalize_qk: bool = False,
        dtype: torch.dtype = torch.float32,
        device: Optional[torch.device] = None,
    ):
