...
class VPSDE(nn.Module):
    ...
    def sample(
        ...
        Arguments:
            ...
            condition: The input information of sound map and source field
    ...
    def sample_ddim(self, condition: Tensor, steps: int = 1000) -> Tensor:
        ...
        with torch.no_grad():
            for i in range(steps):
                ...
                c1 = 0 * torch.sqrt((1 - alpha_t / alpha_next) * (1 - alpha_next) / (1 - alpha_t))
    ...
    def sample_ddpm(self, condition: Tensor, steps: int = 1000, schedule_name: str = "linear") -> Tensor:
        ...
        with torch.no_grad():
            for i in range(1, steps):
                ...
                # Compute alpha, beta, alpha_bar
                alpha_t = alpha_t_steps[i]
                beta_t = beta_t_steps[i]
                alpha_bar_t = alpha_bar_t_steps[i]
